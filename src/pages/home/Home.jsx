                        ...
                        <div className="row about-style1 align-items-center">
                                        ...
                                        <div className="split-box">
                                            <div>
                                                <img
                                                    ...
                                                    className="m-b30"
                                                    src="https://www.creativeparamita.com/wp-content/uploads/2023/10/Night-of-the-Living-Dread-442x705.jpg"
                                                    alt="/"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="split-box ">
                                            <div>
                                                <img
                                                    ...
                                                    src="https://www.creativeparamita.com/wp-content/uploads/2023/05/Flesh-Eaters-Among-Us.jpg"
                                                    alt="/"
                                                />
                                            </div>
                                        </div>
                            ...
                            <div className="col-lg-6 m-b30">
                                <div className="about-content px-lg-4">
                                    ...
                                    <a href="contact-us.html" className="btn btn-primary shadow-primary btnhover">
                                        Contact Us
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-sm-6">
                                <div className="icon-bx-wraper style-1 m-b30 text-center">
                                    <div className="icon-bx-sm m-b10 d-inline-flex align-items-center justify-content-center">
                                        <BsFillLightningFill className="icon-cell" fontSize="25px" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="icon-bx-wraper style-1 m-b30 text-center">
                                    <div className="icon-bx-sm m-b10 d-inline-flex align-items-center justify-content-center">
                                        <IoShieldCheckmark className="icon-cell" fontSize="25px" />
                                    </div>
                                    <div className="icon-content">
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="icon-bx-wraper style-1 m-b30 text-center">
                                    <div className="icon-bx-sm m-b10 d-inline-flex align-items-center justify-content-center">
                                        <BiSolidLike className="icon-cell" fontSize="25px" />
                                    </div>
                                    <div className="icon-content">
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="icon-bx-wraper style-1 m-b30 text-center">
                                    <div className="icon-bx-sm m-b10 d-inline-flex align-items-center justify-content-center">
                                        <FaStar className="icon-cell" fontSize="25px" />
                                    </div>
                                    <div className="icon-content">
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6">
                                <div className="icon-bx-wraper style-3 m-b30">
                                    <div className="icon-lg m-b20">
                                        <FaBookOpen className="icon-cell" />
                                    </div>
                                    <div className="icon-content">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="icon-bx-wraper style-3 m-b30">
                                    <div className="icon-lg m-b20">
                                        <LiaMedalSolid className="icon-cell" />
                                    </div>
                                    <div className="icon-content">
                ...
                <section className="content-inner bg-light">
                    <div className="container">
                        ...
                        <div className="row pricingtable-wraper">
                            <div className="col-lg-4 col-md-6">
                                <div className="pricingtable-wrapper mt-0 style-1 m-b30">
                                    <div className="pricingtable-inner">
                                        ...
                                        <div className="pricingtable-footer">
                                            <a href="pricing.html" className="btn btn-primary btnhover3">
                                                Start Now <i className="fa fa-angle-right m-l10" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="pricingtable-wrapper  mt-0 style-1 m-b30">
                                    <div className="pricingtable-inner">
                                        ...
                                        <div className="pricingtable-price">
                                            <h2 className="pricingtable-bx">
                                                $199<small className="pricingtable-type">/Month</small>
                                            </h2>
                                        </div>
                                        <p className="text">Aliquam dui lacus, lobortis quis sapien non.</p>
                                        <ul className="pricingtable-features">
